	...
	<div class="col-lg-7">
		<div class="card2 card border-1 shadow-lg px-4 py-5 ">
			...
			<form:form action="${addAction}" method="post" modelAttribute="user">
				<div class="row px-3">
					<form:label path="user_Id" class="mb-1">
						<h4 class="mb-0 text-sm">User Id</h4>
					</form:label>
					<form:input class="mb-4" type="text" path="user_Id" name="user_Id"
				...
				<div class="row px-3">
					...
					<form:input type="text" name="text" path="role" readonly="true"></form:input>
				</div>
				<br>
